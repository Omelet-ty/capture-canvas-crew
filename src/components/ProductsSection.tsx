  ...
  const products = [
    {
      ...
      title: "IMPRESIÓN DE FOTOS - Tamaño Normal",
      description: "¡Imprime fotos 10x15/11x15, 13x13 y 13x18!",
      price: "0.70€",
      oldPrice: "1.00€",
      badge: "¡Fácil!",
    ...
    },
    {
      ...
      title: "IMPRESIÓN DE FOTOS - Tamaño Grande",
      description: "¡Ampliaciones en alta calidad de 15x20 a 20x20!",
      price: "0.99€",
      oldPrice: "1.50€",
      badge: "¡TOP!",
    ...
    },
    {
      ...
      description: "¡Lotes de fotos desde 25 unidades!",
      price: "19.95€",
      oldPrice: "24.95€",
      badge: "¡Ventas!",
    ...
    },
    {
      ...
      title: "ENMARCADO PROFESIONAL - Normal",
      description: "Marco elegante para tus mejores recuerdos",
      price: "24.95€",
      oldPrice: "29.95€",
      badge: "¡Nuevo!",
      badgeVariant: "secondary" as const,
    ...
    },
    {
      ...
      title: "MARCO PARA BODAS",
      description: "Marco elegante para inmortalizar el día especial",
      price: "34.95€",
      oldPrice: "39.95€",
      badge: "¡Bodas!",
      badgeVariant: "destructive" as const,
    },
    {
      ...
      title: "MARCO PARA CUMPLEAÑOS",
      description: "Marco festivo para celebraciones inolvidables",
      price: "27.95€",
      oldPrice: "32.95€",
      badge: "¡Fiesta!",
      badgeVariant: "default" as const,
    },
    {
      ...
      title: "ÁLBUM DE FOTOS CLÁSICO",
      description: "Álbum premium con 40 páginas para tus mejores momentos",
      price: "39.95€",
      oldPrice: "49.95€",
      badge: "¡TOP!",
      badgeVariant: "secondary" as const,
